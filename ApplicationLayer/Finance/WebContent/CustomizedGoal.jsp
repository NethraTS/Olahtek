...
<i class="fa fa-refresh fa-spin fa-3x"
      ...
      <section class="bg-primary" id="about">
         <div class="container">
            <div class="row">
             <div class="title-createplan" >Customized Goal <button class="btn btn-primary pull-right" ng-click="goSelectGoal()">Back</button></div>
               <div >
...
<a  class="active-menu"><i class="fa fa-arrow "></i>{{message}}</a>
					...
					<form name="goalDetails" id="goalForm">
                        ...
                        <div class="form-group" align="left" ng-show="show1>1">
                        	<p>Name of the goal
  									<input type="text" class="form-control" maxlength="20" allow-pattern="[a-z]" name="Goalname" ng-model="formdata.Goalname" >
  								</p>
								...
								<div class="form-group" align="left" ng-show="show1>3"><p> Cost of the goal
								<label>
            <input type="radio" name="favoriteColors" ng-checked="formdata.totalCost == 'true'" value="total" ng-model="formdata.totalCost" ng-change="hello()" checked> Total
        </label>
        
        <label>
            <input type="radio" name="favoriteColors" value="peryear" ng-model="formdata.totalCost"> Per Year
             </label>
								...
								<div class="form-group" align="left" ng-show="show1>4" >
      							 ...
      							 <select class="form-control" ng-model="formdata.Goalendingyear" ><option ng-repeat="item in Goalendingyear1" value="{{item.name}}" >{{item.name}}</option></select>
   							 </div>
                			...
                			<form name="myForm">
                			  <div class="form-group" ng-show="show==1" >
                		       <span style="color:red">{{msgerr}}</span>
       							<p>Name of the goal?</p> <input allow-pattern="[a-z]" type="text" maxlength="20" placeholder="goalname"  name="Goalname" ng-model="formdata.Goalname" ><span id="ad1"></span></br></br>
...
>Next</button></br></br>
        					 ...
        					 <span style="color:red">{{msgerr2}}</span>
      							 <p>When will this start?</p>
       							<input type="hidden" name="middlename">
        						<input type="hidden" name="firstname">
        						<select style="width:80px;margin-left: auto;margin-right:auto" class="form-control" ng-model="formdata.Goalstartingyear" ><option ng-selected="formdata.Goalstartingyear==item.name" ng-repeat="item in Goalstartingyear1" value="{{item.name}}" >{{item.name}}</option></select>
       							<br>
       							<button type="button" class="btn btn-primary" onclick="progress_bar2()" ng-click="progressBar0()">Next</button></br></br>
   							 </div>
            ...
            <input type="radio" name="favoriteColors" value="total" ng-value="true" ng-model="formdata.totalCost"> Total
        </label>
            ...
            <input type="radio" name="favoriteColors" value="peryear"  ng-model="formdata.totalCost"> Per Year
             ...
             <div class="input-prepend">
                			 ...
                			 <span style="color:red">{{msgerr3}}</span>
      							 <p>How many years will you need to fund this?</p>
      							 <select class="form-control" ng-model="formdata.Goalendingyear" style="width:80px; margin-left: auto;margin-right:auto"><option ng-selected="formdata.Goalendingyear==item.name" ng-repeat="item in Goalendingyear1" value="{{item.name}}" >{{item.name}}</option></select>
       							<input type="hidden" name="middlename">
        						<input type="hidden" name="firstname"><br><br>
    				...
    				<!-- /.modal -->
    					<div class="right_content">
 							...
 							<table class="table" ng-show="show>4">
 								...
 								<td>Cost of the goal</td><td><span>$</span> {{Goalcost1}}</td></tr>
