<!DOCTYPE html>
<html lang="en" ng-app="MarriageGoalEdit">
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta name="description" content="">
<meta name="author" content="Ranjitha iyengar" >
...
<script src="js/marriageedit.js"></script>
...
<body id="page-top" ng-controller="GoalMarriageEdit" ng-init="load()"
	ng-cloak>
	<div class="MaskLayer"
			...
			<div class="row">
				...
				<div class="title-createplan">
					...
					<button class="btn btn-primary pull-right"
						ng-click="backwithoutsave(formdata)" style="margin-right: 0.3%">Back</button>
						...
						<div class="left_content">
							...
							<form name="goalDetails" id="goalForm">
								...
								<div class="form-group" align="left">
									<p>Marriage Year</p>
									<select class="form-control" ng-model="formdata.marriageyear"><option
											ng-repeat="item in Goalendingyear1" value="{{item.name}}">{{item.name}}</option></select></br>
									...
									<div class="form-group" align="left">
										...
										<div class="slider"></div>
											...
											<div class="form-group" align="left">
										<p>
											Spouse income(Yearly) <span class="money-field"> <input
												type="text" class="form-control" allow-pattern="\d"
												maxlength="12" name="marriagecost" value="$5000"
	                               ...
	                               <p>Spouse age
									...
									<select  ng-model="formdata.sage" class="form-control">
                        			<option ng-selected="age.number == formdata.sage " ng-repeat="age in ages" ng-value="age.number" >{{age.number}}</option>					
                        	</select>
			<div class="form-group" align="left">
										<p>
											Housing expense(Yearly) <span class="money-field"> <input
												type="text" class="form-control" allow-pattern="\d"
												maxlength="12" name="marriagecost" value="$5000"
												ng-model="formdata.housingexpenses1">
										</p>
										</span>
										<div class="slider"></div>
									</div>
											<div class="form-group" align="left">
										<p>
											Non-housing expense(Yearly) <span class="money-field"> <input
												type="text" class="form-control" allow-pattern="\d"
												maxlength="12" name="marriagecost" value="$5000"
												ng-model="formdata.nonhousingexpense1">
										</p>
										</span>
										<div class="slider"></div>
									</div>
					...
					<div class="center-content" style="height: 750px;">
						<div class="center_panel">
							...
							<div class="right_content">
								...
								<div class=" text-center" ng-show="show==7">
									...
									<table class="table">
										...
										<td>Marriage Expense</td>
										<td><span>$</span> {{marriageCost}}</td>
										</tr>
										</tr>
									</table>

								</div>
								<div class=" text-center" ng-show="show==8">
									<i class="fa fa-home fa-5x"></i></br> </br>
									<p>
										{{result}}<span><br>$</span>{{marriageCost}}
									</p>
				...
				<div class="modal-dialog" style="width: 90%;">
					<div class="modal-content">
						...
						<div class="modal-header">
							...
							<button type="button" class="close" data-dismiss="modal"
								aria-hidden="true">&times;</button>
							<h4 class="modal-title">Please tell us how your income and
								expenses will change after marriage, so we can update your
								current goals.</h4>
						</div>
						...
						<div class="modal-body" >
							...
							<div>
								<span style="color: red; font-size: 90%;">{{errormassage}}</span>
							</div>
							<span class="font-para-black"> Spouse income will be <input
								type="text" maxlength="12" allow-pattern="\d"
								onkeypress="return onlyNumbers(event,this)" min="0"
								placeholder="" class="input_bl-long" ng-model="formdata.income" />
								a year.
							</span>
							<span class="font-para-black">  
                        Spouse's age in the current year is
                         
                        	</span>
                        	<select  ng-model="formdata.sage" class="font-dropdown-small">
                        			<option ng-selected="age.number == formdata.sage " ng-repeat="age in ages" ng-value="age.number" >{{age.number}}</option>					
                        	</select>
                        	<span class="font-para-black">  
                        .
						...
						<div class="modal-body">
							<span class="font-para-black">Housing expenses after
							 marriage will increase from <input type="text" maxlength="12"
								allow-pattern="\d" onkeypress="return onlyNumbers(event,this)"
								min="0" placeholder="" class="input_bl-long"
								ng-model="formdata.HousingExpenses" disabled="disabled">
								<span>a year in {{marriageYear-1}} to </span> <input
								type="text" maxlength="12"
								onkeypress="return onlyNumbers(event,this)"  min="0"
								placeholder="" class="input_bl-long"
								ng-model="formdata.newMonthlyExpense"> a year in {{marriageYear}}.
								<br><br>
								Non-housing expense after
								 marriage will increase from <input type="text" maxlength="12"
								allow-pattern="\d" onkeypress="return onlyNumbers(event,this)"
								min="0" placeholder="" class="input_bl-long"
								ng-model="formdata.NonHousingExpense" disabled="disabled">
								<span>a year in {{marriageYear-1}} to </span> <input
								type="text" maxlength="12"
								onkeypress="return onlyNumbers(event,this)"   min="0"
								placeholder="" class="input_bl-long"
								ng-model="formdata.NonHousingExpenses"> a year in {{marriageYear}}.
								...
								ng-model="formdata.expensesStart">
								 	<option ng-repeat="item in Goalendingyear1"
										value="{{item.name}}">{{item.name}}</option>
							</select> <span>to</span> <select
								style="width: 100px; margin-left: auto; margin-right: auto"
								ng-model="formdata.expensesEnd">
									<option ng-repeat="item in Goalendingyear1"
										value="{{item.name}}">{{item.name}}</option>
							</select> <span>a year.</span>  -->
						</div>
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-default"
								data-dismiss="modal">Close</button>
							<button type="button" ng-click="spouseIncome()"
			...
			<div class="modal fade" id="myModal2" role="dialog">
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button type="button" id="dialog-ok" ng-click="deletegoal()"
