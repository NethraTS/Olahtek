<!DOCTYPE html>
<html lang="en" ng-app="KidGoalEdit">
<head>
<meta charset="utf-8">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="#" ng-click="deleteAllCookies()"
						class="page-scroll" href="index.jsp"><i class="fa fa-sign-out"></i>
							Logout</a></li>
						...
						<div class="left_content">
							...
							<form name="goalDetails" id="goalForm">
								...
								<div class="form-group" align="left">
									<p>Start year</p>
									<select class="form-control" ng-model="formdata.startYear"><option
								...
								<div class="form-group" align="left">
									<p>
										Cost of the goal(Yearly)<span class="money-field"> <input
											type="text" class="form-control" allow-pattern="\d"
											maxlength="12" name="Goalcost" value="$0"
				...
				<div class="center-content" style="height: 750px;">
					<div class="center_panel">
						...
						<div class="right_content">
							...
							<div class=" text-center">
								<i class="fa fa fa-home fa-5x"></i></br> </br>
								<p>The annual expense for Raising a kid is $ {{
									annualExpense }}.</p>
								...
								<table class="table">
									...
									<td>Cost of the goal(per year)</td>
									<td>$ {{ goalCost }}</td>
									</tr>
									<td>End year</td>
									<td>{{ endYear}}</td>
