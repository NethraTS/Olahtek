			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Resources <b class="caret"></b></a>
                        ...
                        <li><a href="FderalincomeTaxCalculator.jsp" >FDI Calculator</a></li>
                            ...
                            <li class="dropdown dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Car Calculator</a>
								<ul class="dropdown-menu">
									<li><a href="" data-toggle="modal" data-target="#caseStudy">Car Loan Calculator</a></li>
									<li><a href="" data-toggle="modal" data-target="#caseStudy">Car Lease Calculator</a></li>
								</ul>
							</li>
