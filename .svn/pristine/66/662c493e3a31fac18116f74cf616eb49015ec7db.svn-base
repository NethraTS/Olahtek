...
public class CountyHouseMedianValue {
    ...
    public static void main(String[] args) throws Exception {  
    	Mongo mongo = new Mongo("192.168.1.241", 27017);
  		...
  		collection.drop();
   FileInputStream fileIn = new FileInputStream("C:/Users/Balasubramaniyan/Desktop/New folder/County_MedianSoldPrice_AllHomes.xlsx");
   ...
   // List<Cell> cells1 = new ArrayList<Cell>();
    ...
    BasicDBObject documentDetail = new BasicDBObject();
       ...
       Cell county = row.getCell(columnNo3);
