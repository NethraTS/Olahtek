...
<body  ng-app="formApp1" ng-controller="formController1" id="page-top" ng-init="load()" ng-cloak>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">WealthSetter</a>
            </div>
    ...
    <section class="bg-primary" id="about">
        <div class="container">
			...
			<span style="color:red" ng-show="sentMessage.username.$dirty && sentMessage.username.$invalid">
			...
			<input type=hidden ng-model="formData.form" value="form1" ng-init="formData.form='Userform'" >
                         <label > NAME :</label>       <input type="text" class="form-control" name="username" placeholder="Name" onkeypress="return onlyAlphabetsUsername(event,this)"  ng-click="usercheck()" ng-model="formData.username" required ><span style="color:red" ng-show="sentMessage.username.$dirty && sentMessage.username.$invalid">
			<!-- <span ng-show="sentMessage.username.$error.required">Username is required</span> -->
			...
			<!-- <span ng-show="sentMessage.email.$error.required" >Email is required</span> -->
			</span></p>
                            <!-- </div> -->
                        </div>
                        <div class="row control-group">
                      ...
                      <!--     <input type="submit"  data-toggle="tooltip"  ng-click="validate()" ng-disabled="sentMessage.username.$dirty && sentMessage.username.$invalid || sentMessage.$invalid" value="create"  class="btn btn-success btn-lg">-->
                              <input type="submit"  data-toggle="tooltip"  ng-click="validate()"  value="create"  class="btn btn-success btn-lg">  
                            </div>
                        </div>
                    </form> 
...
<!-- ---------------------------------------                Log in              -------------------------- -->        
		...
		<button type="submit" class="btn btn-success pull-left"  ng-click="login()">
			 Log In!
		</button>
		<button type="button" class="btn btn-danger pull-right"  ng-click="forgot()">
			 Forgot Password!
		</button>
		</div>
		<div ng-show="show1>1">
