...
<div class="MaskLayer" ng-class="{isClosed : !maskedPlotChart}">
	...
	<div class="container-fluid">
	  	<div  class="row">
	    	<div style="margin-left:13%" class="col-sm-4">
			    <table border="0" width="100%">
				<caption>Car Lease Calculator</caption>
				<tr>
					<td style="padding-bottom: 2%;" class="left">Car Price</td>
					<td class="right">
						<input type="text" onkeypress="return numbersonly(event)" maxlength="15" class="form-control" placeholder="$" ng-model="formdata.carPrice" />
					</td>
				</tr>
				<tr>
					<td style="padding-bottom: 2%;" class="left">Lease Term:</td>
				...
				<tr>
					...
					<input type="text" class="form-control ng-pristine ng-valid lease"  maxlength="5" ng-model="formdata.interestRate" />
					</span></td>
			    </tr>
				<tr>
				...
				<!-- <tr>
					...
					<td class="right"><span class="percent1-field">
					<input type="text"  class="form-control ng-pristine ng-valid" onkeypress="return numbersonly(event)" maxlength="3" placeholder="years" ng-model="formdata.loanTerm" /></span>
					</td>
				</tr> -->
				...
				<tr>
					<td style="padding-bottom: 2%;" class="left">Acquisition Cost</td>
					<td class="right"><input type="text" onkeypress="return numbersonly(event)" maxlength="15" class="form-control" placeholder="$" ng-model="formdata.acquisitionCost" /></td>
				
				</tr>
				<tr>
					<td style="padding-bottom: 2%;"  class="left">Residual Value</td>
					<td class="right"><span class="percent-field"> <input type="text"  maxlength="5" class="form-control ng-pristine ng-valid lease"  ng-model="formdata.residualValue" /></span></td>
					
					
				</tr>
				<tr>
					<td style="padding-bottom: 2%;"  class="left">Sale Tax</td>
					<td class="right"><span class="percent3-field"> <input type="text"  maxlength="5" class="form-control ng-pristine ng-valid lease"  ng-model="formdata.saleTax" /></span></td>
				</tr>
				...
				<div style="margin-top:2%;margin-bottom:2%;color:red;text-align: center;">{{cle_msgerr}}</div><br>
				<div style="margin-top:2%;text-align: center;">
					<button  type="button" ng-click="calculate()" class="btn btn-primary">Calculate</button>
				</div>
		</div>
    	<div style="margin-left:7%" class="col-sm-4">
   			<table  width="100%">
			<caption>Payment Summary</caption>
			<tr>
				<th style="padding-bottom: 2%;" class="left">Interest_rate</th>
				<th style="padding-bottom: 2%;" class="right">Monthly Interest rate</th>
			</tr>
			<tr>
 				 <td style="padding-bottom: 2%;" class="left">{{interestrate}}</td>
 				<td style="padding-bottom: 2%;" class="right">{{monthlyinterestrate2}}</td>
			</tr>
			<tr>
				<th style="padding-bottom: 2%;" class="left">Loan</th>
				<th style="padding-bottom: 2%;" class="right">Monthly Payment</th>
			</tr>
			<tr>
				<td style="padding-bottom: 2%;" class="left">{{loan}}</td>
				<td style="padding-bottom: 2%;" class="right">{{monthlypayment1}}</td>
			</tr>
			
			</table>
			<div style="margin-top:2%;text-align: center;">
				<span><b>Monthly Lease Payment : $ {{monthlypayment1}}</b></span>
			</div>
	    </div>
