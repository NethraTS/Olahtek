<!DOCTYPE html>
<html lang="en" ng-app="MarriageGoal">
<head>
<meta charset="utf-8">
...
<body id="page-top" ng-controller="Goalmarriage" ng-init="load()"
	ng-cloak>
			...
			<div class="row">
				...
				<div>
					...
					<div class="center-content" style="height: 750px;">
											...
											<form name="myForm">
												<div class="form-group" ng-show="show==1">
													...
													<select class="form-control"
														ng-model="formdata.marriageyear"
													...
													<button type="button" class="btn btn-primary"
														onclick="progress_bar()" ng-click="load1();progressBar();">Next</button>
													</br>
													</br>
												</div>
												<span></span> <span></span>
												<div class="form-group" ng-show="show==3">
													...
													<p>What is the expected cost of your marriage?</p>
													<input type="hidden" name="middlename"> <input
														...
														placeholder="20000" value="24960"
														ng-model="formdata.marriagecost"></span></br>
													</br> <input type=hidden ng-model="formdata.actionHomeType"
														value="form1" ng-init="formdata.actionHomeType='insert'">
													<button type="button" class="btn btn-primary"
														onclick="progress_bar2()" data-toggle="collapse"
														data-target="#marriage-modal">Next</button>
													</br>
													</br>
												</div>
						...
						<div id="marriage-modal" class="modal fade" role="dialog">
							<div class="modal-dialog"
								style="width: 90%; margin-top: -1%; padding-left: 7%; margin-left: -11.3%">
								<div class="modal-content">
									...
									<!-- 	<button type="button" class="close" data-dismiss="modal"
										...
										<h4 class="modal-title">Please tell us how your income
											and expenses will change after marriage, so we can update
											your current goals.</h4>
									</div>
									...
									<div class="modal-body">
										...
										<span class="font-para-black"> Spouse income will be <input
											...
											ng-model="formdata.income" /> a year.
										</span> <span class="font-para-black"> Spouse's age in the
											current year is </span> <select ng-model="formdata.sage"
											class="font-dropdown-small">
											<option ng-selected="age.number == formdata.sage "
												ng-repeat="age in ages" ng-value="age.number">{{age.number}}</option>
										</select> <span class="font-para-black"> . </span>
									...
									<div class="modal-body">
										<span class="font-para-black">Housing expenses after
											...
											<span>a year in {{formdata.marriageyear-1}} to </span> <input
											type="text" maxlength="12" allow-pattern="\d"
											onkeypress="return onlyNumbers(event,this)" min="0"
											placeholder="" class="input_bl-long"
											ng-model="formdata.newMonthlyExpense"> a year in
											{{formdata.marriageyear}}. <br>
										<br> Non-housing expense after marriage will increase
											from <input type="text" maxlength="12" allow-pattern="\d"
											onkeypress="return onlyNumbers(event,this)" min="0"
											placeholder="" class="input_bl-long"
											...
											onkeypress="return onlyNumbers(event,this)" min="0"
											placeholder="" class="input_bl-long"
											ng-model="formdata.NonHousingExpenses"> a year in
											{{formdata.marriageyear}}. <!-- <select
								style="width: 100px; margin-left: auto; margin-right: auto"
								...
								ng-model="formdata.expensesEnd">
									...
									<!-- 	<button type="button" class="btn btn-default"
										...
										<button type="button" ng-click="progressBar1()"
